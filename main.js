$(document).ready(function(){
	a = '#main_flow ';
	//m_,r2_,and r2_1 is a collection of input controls
	m_ = [
		[$(a+'#r_0'),$(a+'#r_0 #q_0')],
		[$(a+'#r_1'),$(a+'#r_1 #q_1')],
		[$(a+'#r_2'),$(a+'#r_2 #q_2')],
	...
	//various functions that lead to the evaluation of the point group
...
//miscellaneous functions that allow ease of control/input-hiding
function m_show(){
	$.each(m_,function(key,v){
		v[0].show();
	});
